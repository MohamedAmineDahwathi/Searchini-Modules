	...
	.then( (response)=>{
      ...
      products.forEach(elem => {
        data.push({
           ...
           price: elem['json']['minPrice'],
        oldPrice: elem['json']['minOldPrice']
            });
      });
	}).catch(function (err) {
        console.log(err);
